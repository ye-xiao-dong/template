...
import com.yd.springbootdemo.utils.random.RandomUtil;
...
public class NetUtil {
	...
	public static Collection<NetworkInterface> getNetworkInterfaces() {
		...
		return CollUtil.addAll(new ArrayList<NetworkInterface>(), networkInterfaces);
	}
	...
	public static LinkedHashSet<String> localIpv4s() {
		final LinkedHashSet<InetAddress> localAddressList = localAddressList(new Predicate<InetAddress>() {
