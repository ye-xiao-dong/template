...
import com.yd.springbootdemo.utils.collection.IterUtil;
...
public class ObjUtil {
	...
	public static <T> T cloneByStream(T obj) {
		if (null == obj || !(obj instanceof Serializable)) {
			...
			try{
				obj = JsonUtil.jsonStrToObj(JsonUtil.toJsonStr(obj), ClassUtil.getClass(obj));
			}catch(Exception e){
				return null;
			}
			return obj;
	...
	public static <T> byte[] serialize(T obj) {
		...
		FastOutputStream byteOut = new FastOutputStream();
