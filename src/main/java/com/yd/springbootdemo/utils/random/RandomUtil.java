...
import com.yd.springbootdemo.utils.random.WeightRandom.WeightObj;
...
public class RandomUtil {
	...
	public static double randomDouble(double min, double max, int scale, RoundingMode roundingMode) {
		return NumUtil.round(randomDouble(min, max), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(int scale, RoundingMode roundingMode) {
		return NumUtil.round(randomDouble(), scale, roundingMode).doubleValue();
	}
	...
	public static double randomDouble(double limit, int scale, RoundingMode roundingMode) {
		return NumUtil.round(randomDouble(limit), scale, roundingMode).doubleValue();
	}
	...
	public static BigDecimal randomBigDecimal() {
		return NumUtil.toBigDecimal(getRandom().nextDouble());
	}
	...
	public static BigDecimal randomBigDecimal(BigDecimal limit) {
		return NumUtil.toBigDecimal(getRandom().nextDouble(limit.doubleValue()));
	}
	...
	public static BigDecimal randomBigDecimal(BigDecimal min, BigDecimal max) {
		return NumUtil.toBigDecimal(getRandom().nextDouble(min.doubleValue(), max.doubleValue()));
	}
	...
	public static <T> Set<T> randomEleSet(Collection<T> collection, int count) {
		final ArrayList<T> source = new ArrayList<>(CollUtil.unique(collection));
		if (count > source.size()) {
			throw new IllegalArgumentException("Count is larger than collection unique size !");
		}
